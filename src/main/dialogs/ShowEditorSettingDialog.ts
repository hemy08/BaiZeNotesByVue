...
import { getEditorSettingCSS } from './editor-setting-css'
import { getEditorSettingScript } from './editor-setting-script'
...
function generateEditorSettingHTML(themeStyles: ThemeStyles, systemSettings: SystemSetting): string {
    ...
    style.textContent = getEditorSettingCSS(themeStyles, systemSettings)
    ...
    script.textContent = getEditorSettingScript()
...
function createBasicSection(document: Document): HTMLElement {
    ...
    section.innerHTML = `
        ...
        <div class="settings-grid"><p style="color: var(--secondary-text-color); font-size: var(--font-size-xs); margin-bottom: var(--spacing-sm);">
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">空格数</span>
            </div>
        </div>
    ...
    section.innerHTML = `
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">个</span>
            </div>
        </div>
    ...
    section.innerHTML = `
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">毫秒</span>
            </div>
        </div>
    ...
    section.innerHTML = `
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">像素</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">0表示自动</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">字符</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">用逗号分隔</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">条轨道</span>
            </div>
        </div>
    ...
    section.innerHTML = `
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">像素(仅块状光标)</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">行</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">列</span>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="setting-value">
                ...
                <span style="margin-left: var(--spacing-xs); color: var(--secondary-text-color); font-size: var(--font-size-xs);">-1表示无限制</span>
            </div>
        </div>
    </div>`
...
function createSubobjectsSection(document: Document): HTMLElement {
    ...
    section.innerHTML = `
        ...
        <p style="color: var(--secondary-text-color); font-size: var(--font-size-xs); margin-bottom: var(--spacing-sm);">

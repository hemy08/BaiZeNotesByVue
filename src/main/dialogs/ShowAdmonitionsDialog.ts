...
function makeAdmonitionDialogHtml(): string {
  ...
  .quote>.admonition-title:after,.quote>summary:after { color: #9e9e9e }
  .admonition.pied-piper, .md-typeset details.pied-piper {
      border-color: rgb(43, 155, 70);
  }

  .pied-piper > .admonition-title, .md-typeset .pied-piper > summary {
      background-color: rgba(43, 155, 70, 0.1);
  }

  .pied-piper > .admonition-title::before, .md-typeset .pied-piper > summary::before {
  ...
  eleScript.textContent = `
    ...
    document.getElementById('applyButton').onclick = function(e) {

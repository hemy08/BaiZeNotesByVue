...
export const W3School: MenuContext[] = generateMenuContext(MenuConsts.W3SchoolUrlMaps)
export const EncodeDecode: MenuContext[] = generateMenuContext(MenuConsts.EncDecUrlMaps)
export const OnlineIDE: MenuContext[] = generateMenuContext(MenuConsts.IdeUrlMaps)
export const Links: MenuContext[] = generateMenuContext(MenuConsts.OnlineToolMaps)
export const DevOpsTool: MenuContext[] = generateMenuContext(MenuConsts.DevelopUrlMaps)
export const OpenWebTeam: MenuContext[] = generateMenuContext(MenuConsts.TeamUrlMaps)
export const CloudCommunity: MenuContext[] = generateMenuContext(MenuConsts.CloudUrlMaps)
...
export const GitHubProject: MenuContext[] = generateMenuContext(MenuConsts.GitHubUrlMaps)

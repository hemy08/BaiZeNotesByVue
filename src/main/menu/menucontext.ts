...
export const W3School: MenuContext[] = [
    ...
    {
        label: '全角/半角转换工具',
        context: 'https://www.w3cschool.cn/tools/index?name=fullhalfcode'
    },
    ...
    {
        label: 'Excel/CSV转JSON',
        context: 'https://www.w3cschool.cn/tools/index?name=excel_col2json'
    },
...
export const EncodeDecode: MenuContext[] = [
    ...
    {
        label: '在线编码转换',
        context: 'https://www.w3cschool.cn/tools/index?name=urlencode_decode'
    },
    ...
    {
        label: 'Native/ASCII转换',
        context: 'https://www.w3cschool.cn/tools/index?name=native2ascii'
    },
    ...
    {
        label: 'MD5在线加密',
        context: 'https://www.w3cschool.cn/tools/index?name=CreateMD5Password'
    },
    {
        label: '高强度密码生成',
    ...
    {
        label: 'URL网址16进制加密',
        context: 'https://www.w3cschool.cn/tools/index?name=urlencodepwd'
    },
...
export const OnlineIDE: MenuContext[] = [
    ...
    {
        label: 'NodeJs语言',
        context: 'https://www.w3cschool.cn/tryrun/runcode?lang=javascript-node'
    },
...
export const DevOpsTool: MenuContext[] = [
    ...
    {
        label: '在线 AES-128,AES-256 加密',
        context: 'https://tool.box3.cn/aes-encrypt-128-256.html'
    },
    {
        label: '在线 AES-128,AES-256 解密',
        context: 'https://tool.box3.cn/aes-decrypt-128-256.html'
    },

<template>
  ...
  <button id="f-sub" title="下标" class="tool-btn" @click="onInsertText('<sub> </sub>')"></button>
  <!-- 文字左对齐 文字居中 两边对其 文字右对齐 -->
  <button id="align-left" title="左对齐" class="tool-btn" @click="onFontFormat('alignleft')"></button>
  <button id="align-center" title="文字居中" class="tool-btn" @click="onFontFormat('aligncenter')"></button>
  <button id="align-justify" title="两边对齐" class="tool-btn" @click="onFontFormat('alignjustify')"></button>
  <button id="align-right" title="右对齐" class="tool-btn" @click="onFontFormat('alignright')"></button>
  <!-- 有序列表 无序列表 水平线 段内换行 -->
  ...
  <button id="task-lists" title="任务列表" class="tool-btn"></button>
  ...
  <button id="i-emoji" title="Emoji" class="tool-btn" @click="onEmojiContextMenu"></button>
  <button id="i-symbol" title="特殊符号" class="tool-btn" @click="onSymbolsContextMenu"></button>
  <button id="i-label" title="标记" class="tool-btn"></button>
  <!-- material mermaid plantuml -->
  <button id="i-mermaid" title="mermaid" class="tool-btn" @click="onMermaidContextMenu"></button>
  <button id="i-plantuml" title="plantuml" class="tool-btn" @click="onPlantUmlContextMenu"></button>
</template>
...
function onEmojiContextMenu(e: MouseEvent) {
  handleEmojiContextMenu(e)
}

function onSymbolsContextMenu(e: MouseEvent) {
  handleSymbolContextMenu(e)
}

function onMermaidContextMenu(e: MouseEvent) {
  handleMermaidContextMenu(e)
}

function onPlantUmlContextMenu(e: MouseEvent) {
  handlePlantUmlContextMenu(e)
}

...
const helpMenu: BaiZeMenuItem = {
    ...
    submenu: [
        { label: '版本发布', submenu: [
            { label: 'v1.2.2', menu_action: 'baize:menu:help:release-notes:v1.2.2' },
            { label: 'v1.2.1', menu_action: 'baize:menu:help:release-notes:v1.2.1' },
            { label: 'v1.2.0', menu_action: 'baize:menu:help:release-notes:v1.2.0' },
            { label: 'v1.1.5', menu_action: 'baize:menu:help:release-notes:v1.1.5' },
            { label: 'v1.1.3', menu_action: 'baize:menu:help:release-notes:v1.1.3' },
            { label: 'v1.1.2', menu_action: 'baize:menu:help:release-notes:v1.1.2' },
            { label: 'v1.1.1', menu_action: 'baize:menu:help:release-notes:v1.1.1' },
            { label: 'v1.1.0', menu_action: 'baize:menu:help:release-notes:v1.1.0' },
            { label: 'v1.0.2', menu_action: 'baize:menu:help:release-notes:v1.0.2' },
            { label: 'v1.0.1', menu_action: 'baize:menu:help:release-notes:v1.0.1' },
            { label: 'v1.0.0', menu_action: 'baize:menu:help:release-notes:v1.0.0' },
        ]},
        { label: '修改日志', submenu: [
            { label: '重大版本升级', menu_action: 'baize:menu:help:update-log' },
        ]},
        { type: 'separator' },

...
const EncryptPad = [
    ...
    {
        id: 'encrypt-pad-AnsiX923',
        value: 'AnsiX923',
        text: 'AnsiX923 (ANSI X.923 padding strategy)'
    },
    {
        id: 'encrypt-pad-Iso10126',
        value: 'Iso10126',
        text: 'Iso10126 (ISO 10126 padding strategy)'
    },
    {
...
function handleDecrypt() {
    ...
    try {
        const decrypted = cryptoAlg[encDecAlg.value].decrypt(
            EncryptResult.value,
            secretKey,
            options
        )

        ...
        <Transition name="dialog-scale">
          ...
          >
            ...
            <div class="container">
              ...
              <div v-for="group in upgradeGroups" :key="group.title" class="section">
              ...
              <div class="section">
                ...
                <div class="fix-list">
                  <div v-for="fix in codeFixes" :key="fix" class="fix-item">
              ...
              <div class="section">
                ...
                <div class="verify-grid">
                  <div class="verify-item">
                    ...
                    <span>TypeScript (Node): 0 错误</span>
                  </div>
                  <div class="verify-item">
                    <span class="verify-icon">✅</span>
                    <span>TypeScript (Web): 0 错误</span>
                  </div>
                  <div class="verify-item">
                    <span class="verify-icon">✅</span>
                    <span>ESLint: 无错误</span>
                  </div>
                  <div class="verify-item">
                    <span class="verify-icon">✅</span>
                    <span>单元测试: 21/21 通过</span>
                  </div>
                  <div class="verify-item">
                    <span class="verify-icon">✅</span>
                    <span>开发模式: 启动成功</span>
            ...
            <div class="footer">
              白泽笔记 v1.2.1 · 基于 Electron 43 + Vue 3.5 + TypeScript 6.0
            </div>
          </div>
        </Transition>
      </div>
...
const upgradeGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'katex', old: '^0.16.10', new: '^0.18.6.4', type: 'minor' },
...
.title-bar {
  height: 48px;
  background: var(--title-bar-gradient, linear-gradient(135deg, #667eea, #764ba2));
  display: flex;

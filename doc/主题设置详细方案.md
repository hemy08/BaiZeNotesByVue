...
1. **双主题配置**：支持应用主题和编辑器主题分开设置，提供更灵活的个性化体验
2. 选择应用主题（20 个预设主题）
3. 选择 Monaco 编辑器主题（55 个主题）
4. 单独配置编辑区主题（可选）
5. 实时预览主题效果
6. 持久化主题配置
7. 主题实时切换，所有窗口同步更新
...
```typescript
// 主题类型定义
export type ThemeType = 'baize' | 'warm' | 'light' | ... // 20个应用主题
export type MonacoThemeType = 'vs' | 'vs-dark' | 'hc-black' | ... // 55个Monaco主题
